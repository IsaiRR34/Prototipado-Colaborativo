...
public class BossBabyController : MonoBehaviour
{
    ...
    [SerializeField] private float stunDuration = 4.0f; // Exacto al GDD
    ...
    private IEnumerator Phase1StalkRoutine()
    {
        ...
        // Parpadeo de advertencia en ojos / cabeza durante 1.8 segundos
        float timer = 0f;
    ...
    private IEnumerator Phase2ChargeRoutine()
    {
        ...
        while (isCharging && elapsed < maxChargeDuration && currentPhase == BossPhase.Phase2_Enraged)
        {
            ...
            // Chequeo de colisión frontal contra muros / obstáculos
    ...
    private IEnumerator CrashAndStun(Vector3 hitPoint)
    {
        ...
        // Screen Shake violento por el impacto
        ...
        // Animación de mareo / aturdimiento (inclinación lateral con DOTween)
    ...
    private void OnControllerColliderHit(ControllerColliderHit hit)
    {
        if (isCharging)
        {
            ...
            // Si choca con una pared / obstáculo
    ...
    /// <summary>
    /// Aplicación de daño al jefe con diferenciación de disparo a la cabeza (Headshot)
    /// </summary>
    public void TakeDamage(float damage, bool isHeadshot)
    {
        ...
        // Chequeo de transición a Fase 2 (Furia / Colisión) al llegar al 50% de vida
    ...
    private void Die()
    {
        ...
        // Transición a la victoria tras un breve delay dramático
