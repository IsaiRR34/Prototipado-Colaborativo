...
public class LG_Shoot : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (reloadPressed)
        {
            ...
            {
                LG_TooltipManager.Instance?.ShowTooltipTemporary("Cargador lleno", 1.3f);
            }
    ...
    private void ShootBullet()
    {
        ...
        if (SoundList.Instance != null) SoundList.Instance.PlaySoundRandomPitch("SFX_ARShot", 0.85f, 1.15f);
